    ...
    return (
        <div className='pb-20 pt-10 w-full'>
            ...
            <div className='grid md:grid-cols-2 grid-cols-1  '>
                ...
                <textarea onInput={(e)=>setInput(e.target.value)} className='border p-10 rounded-2xl' name="from" id="" cols="52" rows="10" placeholder='Type Here'></textarea>
                </div>
                <div className='mx-auto'>
                <textarea value={output} className='border p-10 rounded-2xl ' name="to" id="" cols="52" rows="10" placeholder='Results'></textarea><br />
